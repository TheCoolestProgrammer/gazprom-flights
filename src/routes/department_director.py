...
async def dashboard(
    ...
    all_requests = (
        ...
        .filter(Passenger.department_id == user.department_id)
        .all()
    )
    ...
    return templates.TemplateResponse(
        request=request,
        name="department_director/dashboard.html",
        context={
            "user": user,
            "requests": requests,
...
async def cargo_dashboard(
    ...
    all_requests = (
        session.query(Cargo).filter(Cargo.department_id == user.department_id).all()
    )
    unique_cities_from = set()
    unique_cities_to = set()
    ...
    return templates.TemplateResponse(
        request=request,
        name="department_director/cargo_dashboard.html",
        context={
            "user": user,
